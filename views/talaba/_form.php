...
<div class="talaba-form">
    ...
    <?=$form->field($model, 'otasining_ismi')->textInput(
            [
                'maxlength' => true,
    ...
    <?=$form->field($model, 'region_id')->dropDownList(
            ...
            [
                ...
                'onchange' => '$.post( "' . urldecode(
                        Yii::$app->urlManager->createUrl('district/lists?id='))
                        . '"+$(this).val()+"&faculty_id=", 
                        function( data ) {
    ...
    <?=$form->field($model, 'kurs_id')->dropDownList(
        ...
        [
            ...
            'onchange' => '$.post("/program/lists?faculty_id="
    ...
    <?=$form->field($model, 'qavat_id')->dropDownList(
        ...
        [
                ...
                'onchange' => '$.post( "' . urldecode(
                        Yii::$app->urlManager->createUrl('xonalar/lists?id='))
                    . '"+$(this).val(), 
                    function( data ) {
